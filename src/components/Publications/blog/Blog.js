...
const Blog=()=>{
    return (
        ...
        <div>
            ...
            <h1>How to Become a
                <span>Graphic</span>Designer in
                <span>10 simple steps</span>
            </h1>
        </div>
        <div>
            <div>
                <img src="images/blog.jpg" alt="blog-img"/>
                <div>
                    <h6>CATEGORY :<span>TECHNOLOGY</span></h6>
                    <h6>DATE :<span>APRIL 2023</span></h6>
                    <h6>AUOTHER :<span>PAUL TRUEMAN</span></h6>
                </div>
            </div>
            <div>
                <p>Are you passionate about design and interested in pursuing a career as a graphic designer? 
